    ...
    <main class="container-xxl mt-5" id="container">
        <div class="row mb-5">
            <div class="card p-0">
                ...
                <div class="card-footer d-flex flex-row justify-content-end">
                    <button type="button" class="btn btn-light btn-pedido" data-bs-toggle="modal" data-bs-target="#pedido-modal-1">
                        Resumo de itens
                    </button>
                </div>
            </div>
        ...
        <div class="row mb-5">
            <div class="card p-0">
                ...
                <div class="card-footer d-flex flex-row justify-content-end">
                    <button type="button" class="btn btn-light btn-pedido" data-bs-toggle="modal" data-bs-target="#pedido-modal-2">
                        Resumo de itens
                    </button>
                </div>
            </div>
