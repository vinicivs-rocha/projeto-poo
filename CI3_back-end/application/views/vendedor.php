                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" name="name" id="name" class="form-control" disabled readonly />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                    ...
                    <div class="modal-body">
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" name="client-gendet" id="client-gender" class="form-control" />
                            </div>
                        </div>
                        <div class="row g-3 justify-content-start mb-3">
                            <div class="col-2">
                                <label for="client-age" class="form-label">Idade:</label>
                                <input type="number" name="client-age" id="client-age" class="form-control" />
                            </div>
                            <div class="col-4">
                                <label for="client-phone" class="form-label">Telefone:</label>
                                <input type="tel" name="client-phone" id="client-phone" class="form-control" />
                            </div>
                        </div>
                        <div class="row g-3 justify-content-start">
                            <div class="col-4">
                                <label for="client-cpf" class="form-label">CPF:</label>
                                <input type="text" name="client-cpf" id="client-cpf" class="form-control" />
                            </div>
                            <div class="col-6">
                                <label for="client-email" class="form-label">Email:</label>
                                <input type="email" name="clien-email" id="client-email" class="form-control" />
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
