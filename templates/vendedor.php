                ...
                <div class="col-4">
                    <div class="card shadow">
                        ...
                        <img
                            ...
                            alt="Imagem da Argamassa para Assentamento de Porcelanato Interno E Externo 20kg Branca"
                        ...
                        >
                            ...
                            >
                                <i
                                    class="fi fi-rr-cart-arrow-down fi-add-cart d-flex"
                                ></i>
                            </button>
                        </div>
                    </div>
                    ...
                    <form action="/cliente" method="post">
                        <div class="modal-body">
                            ...
                            <div class="row g-3 justify-content-start mb-3">
                                <div class="col-2">
                                    <label for="client-age" class="form-label"
                                        >Idade:</label
                                    >
                                    <input
                                        type="number"
